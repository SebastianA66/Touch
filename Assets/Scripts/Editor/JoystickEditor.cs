...
public class JoystickEditor : Editor
{
    ...
    {
        EditorGUILayout.PropertyField(handleRange, new GUIContent("Handle Range", "The distance the visual handle can move from the centre of the joystick"));
        EditorGUILayout.PropertyField(deadZone, new GUIContent("Dead Zone", "The distance away from the centre input has to be before registering"));
        ...
        EditorGUILayout.PropertyField(snapY, new GUIContent("Snap Y", "Snap the vertical input to a while value"));
